...
export default function HeroSection ({ setCurrentSection }) {
    ...
    return (
        <div className="py-10 md:h-screen min-h-screen md:max-h-screen bg-slate-900 text-slate-300 overflow-hidden">
            <HeaderSection onSelect={setCurrentSection}/>
            <div className="flex flex-col h-full">
                <div className="flex-1 px-10 md:px-20 flex flex-col gap-5 md:gap-0 md:flex-row h-full [&>*]:flex-1">
                    <div className="flex justify-center items-center">
                        <div className="flex flex-col justify-center items-left [&>*]:text-left">
                            <h1 className="text-2xl md:text-9xl font-black text-slate-300/80 ">JOHN ELLIOTT</h1>
                            <h2 className="text-lg md:text-3xl text-slate-300/80 font-bold">- Frontend Developer</h2>
                            ...
                            <button onClick={() => {setCurrentSection(3)}} className="hidden md:block px-3 py-2 rounded-xl w-fit border-1 border-cyan-800 bg-cyan-600 text-slate-300 cursor-pointer font-bold mt-5">CONTACT ME</button>
                        </div>                        
                    </div>
                    <div className="flex justify-center items-center relative">
                        <img src={heroImage} className='md:w-[450px] md:h-[450px] rounded-full object-cover border-4 border-cyan-600 shadow-[0_0_60px_rgba(8,145,178,0.35)]'/>
                    </div>
                </div>
            </div>
        </div>
...
function HeaderSection ({ onSelect }) {
    ...
    return (
        <div className="hidden md:flex h-1/12 w-full px-10 items-center justify-between text-slate-600 font-bold absolute border-b-1 border-slate-800">
