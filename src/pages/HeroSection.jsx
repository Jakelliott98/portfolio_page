...
export default function HeroSection () {
    ...
    return (
        <div className="h-screen max-h-screen bg-slate-900 text-slate-300 overflow-hidden">
            <nav className="h-1/12 bg-slate-900 px-10 flex justify-around items-center">
                <a className=''>HOME</a>
                <a className=''>ABOUT</a>
                <a className=''>WORK</a>
            ...
            <div className="px-10 flex h-full [&>*]:flex-1">
                ...
                `<div className="flex flex-col justify-center items-left [&>*]:text-left">
                    ...
                    <h2 className="text-3xl">- It's John a Frontend Developer</h2>
                ...
                <div className="flex h-full h-fit">
                    <img src={headshot} className='bg-contain'/>
                </div>
            </div>
        </div>
    )
