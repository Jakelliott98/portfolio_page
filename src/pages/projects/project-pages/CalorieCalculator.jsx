...
function CalorieCalculator () {
    ...
    <div className="min-h-screen px-40 py-15 bg-slate-900 flex flex-col gap-5 text-white">
        ...
        <div>
            <h1 className="text-center text-5xl font-black">Calorie Calculator</h1>
